...
class MagentoUtils {
  ...
  static Map<String, dynamic> buildFilter({
    ...
    return {'field': field, 'value': value, 'condition_type': conditionType};
  }
  ...
  static double roundToCurrencyPrecision(double amount) {
    return double.parse(
      amount.toStringAsFixed(MagentoConstants.pricePrecision),
    );
  }
  ...
  static bool isValidPage(int page) {
    return page >= MagentoConstants.minPage && page <= MagentoConstants.maxPage;
  }
