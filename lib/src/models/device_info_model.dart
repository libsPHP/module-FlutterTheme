...
class DeviceInfoModel {
  ...
  DevicePerformanceInfo get performanceInfo {
    ...
    if (platform == 'iOS') {
      ...
      if (sdkInt >= 31) score += 15;
      else if (sdkInt >= 28) score += 10;
      else if (sdkInt >= 24) score += 5;
    ...
    // Анализ RAM
    if (ramMb != null) {
      if (ramMb! >= 8000) score += 15;
      else if (ramMb! >= 6000) score += 10;
      else if (ramMb! >= 4000) score += 5;
      else if (ramMb! < 2000) score -= 10;
    }
