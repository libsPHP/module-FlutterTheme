    ...
    return Row(
      ...
      children: List.generate(maxRating, (index) {
        ...
        if (starRating <= rating) {
          return Icon(Icons.star, size: size, color: activeStarColor);
        } else if (starRating - 0.5 <= rating) {
          return Icon(Icons.star_half, size: size, color: activeStarColor);
        } else {
          return Icon(Icons.star_border, size: size, color: inactiveStarColor);
        }
      }),
    );
  }
