...
import 'package:flutter_magento/src/marketplace/providers/marketplace_providers.dart';
import 'package:flutter_magento/src/marketplace/widgets/seller_card.dart';
import 'package:flutter_magento/src/marketplace/models/seller.dart';
...
class _MarketplaceHomeScreenState extends ConsumerState<MarketplaceHomeScreen>
  ...
  Widget _buildRecentProducts(BuildContext context) {
    return const Padding(
      ...
      child: Center(child: Text('Recent products will be displayed here')),
    );
  }
