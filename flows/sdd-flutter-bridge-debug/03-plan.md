# Implementation Plan: BridgeDebug
...
- **Files**:
  - `NativeMind_BridgeDebug/registration.php` - Create
  - `NativeMind_BridgeDebug/composer.json` - Create
  - `NativeMind_BridgeDebug/etc/module.xml` - Create
...
- **Description**: Create /Bridge/debug/config controller
- **Files**:
...
- **Description**: Create /Bridge/debug/route controller
- **Files**:
...
- **Description**: Create /Bridge/debug/seo controller
- **Files**:
...
- **Description**: Create /Bridge/debug/applinks controller
- **Files**:
...
| File | Action | Reason |
|------|--------|--------|
| `NativeMind_BridgeDebug/registration.php` | Create | Module registration |
| `NativeMind_BridgeDebug/composer.json` | Create | Composer package |
| `NativeMind_BridgeDebug/etc/module.xml` | Create | Module declaration |
| `NativeMind_BridgeDebug/etc/frontend/routes.xml` | Create | Debug routes |
| `NativeMind_BridgeDebug/Helper/DebugHelper.php` | Create | Debug data collector |
| `NativeMind_BridgeDebug/Controller/Debug/Config.php` | Create | Config endpoint |
| `NativeMind_BridgeDebug/Controller/Debug/Route.php` | Create | Route endpoint |
| `NativeMind_BridgeDebug/Controller/Debug/Seo.php` | Create | SEO endpoint |
| `NativeMind_BridgeDebug/Controller/Debug/AppLinks.php` | Create | AppLinks endpoint |
| `NativeMind_BridgeDebug/Block/ConsoleLogger.php` | Create | Console logger block |
| `NativeMind_BridgeDebug/view/frontend/templates/console_logger.phtml` | Create | Console script |
| `NativeMind_BridgeDebug/view/frontend/layout/default.xml` | Create | Block injection |
