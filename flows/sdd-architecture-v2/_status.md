...
### PHP (Magento)
- `NativeMind_FlutterBridgeRoutes/Model/Route/RoutePayloadBuilderInterface.php` (new)
- `NativeMind_FlutterBridgeRoutes/Model/Route/CanonicalResolverInterface.php` (new)
- `NativeMind_FlutterBridgeRoutes/Model/Route/DefaultCanonicalResolver.php` (new)
- `NativeMind_FlutterBridgeRoutes/Model/Route/RoutePayloadBuilderPool.php` (new)
- `NativeMind_FlutterBridgeRoutes/Model/Route/ProductRoutePayloadBuilder.php` (new)
- `NativeMind_FlutterBridgeRoutes/Model/Route/CategoryRoutePayloadBuilder.php` (new)
- `NativeMind_FlutterBridgeRoutes/Model/Route/CmsRoutePayloadBuilder.php` (new)
- `NativeMind_FlutterBridgeRoutes/Model/Route/SearchRoutePayloadBuilder.php` (new)
- `NativeMind_FlutterBridgeRoutes/Model/Route/SimpleRoutePayloadBuilder.php` (new)
- `NativeMind_FlutterBridgeRoutes/Model/Route/RoutePayload.php` (modified - added sourceUrl)
- `NativeMind_FlutterBridgeRoutes/Block/RouteMeta.php` (modified - delegates to services)
- `NativeMind_FlutterBridgeRoutes/etc/di.xml` (new)
- `NativeMind_FlutterBridgeFlutterWeb/Helper/Config.php` (modified - new config options)
- `NativeMind_FlutterBridgeFlutterWeb/Block/Loader.php` (modified - full config)
