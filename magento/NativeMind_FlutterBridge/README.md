...
```bash
composer require nativemind/module-flutter-bridge
bin/magento module:enable NativeMind_FlutterBridge
...
1. Create directory `app/code/NativeMind/FlutterBridge`
...
```
https://your-store.com/flutterbridge/debug/route
```
