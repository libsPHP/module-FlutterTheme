<?php
/**
 * NativeMind FlutterBridge Configuration Helper
 *
 * @category    NativeMind
...
namespace NativeMind\FlutterBridge\Helper;
...
class Config extends AbstractHelper
{
    ...
    // Route
    public const XML_PATH_ROUTE_ENABLED = 'nativemind_flutterbridge/route/enabled';
    public const XML_PATH_ROUTE_STANDARD_VERSION = 'nativemind_flutterbridge/route/standard_version';
    public const XML_PATH_ROUTE_PRODUCT = 'nativemind_flutterbridge/route/product_app_route';
    public const XML_PATH_ROUTE_CATEGORY = 'nativemind_flutterbridge/route/category_app_route';
    public const XML_PATH_ROUTE_CMS = 'nativemind_flutterbridge/route/cms_app_route';
    public const XML_PATH_ROUTE_SEARCH = 'nativemind_flutterbridge/route/search_app_route';
    public const XML_PATH_ROUTE_CART = 'nativemind_flutterbridge/route/cart_app_route';
    public const XML_PATH_ROUTE_CHECKOUT = 'nativemind_flutterbridge/route/checkout_app_route';
    public const XML_PATH_ROUTE_CUSTOMER = 'nativemind_flutterbridge/route/customer_app_route';
    public const XML_PATH_ROUTE_HOME = 'nativemind_flutterbridge/route/home_app_route';

    // Canonical
    public const XML_PATH_CANONICAL_ENABLED = 'nativemind_flutterbridge/canonical/enabled';
    public const XML_PATH_CANONICAL_PRODUCT_MODE = 'nativemind_flutterbridge/canonical/product_mode';
    public const XML_PATH_CANONICAL_CATEGORY_FILTERED = 'nativemind_flutterbridge/canonical/category_filtered_mode';
    public const XML_PATH_CANONICAL_STRIP_UTM = 'nativemind_flutterbridge/canonical/strip_utm';
    public const XML_PATH_CANONICAL_STRIP_TRACKING = 'nativemind_flutterbridge/canonical/strip_tracking';

    // Robots
    public const XML_PATH_ROBOTS_SEARCH = 'nativemind_flutterbridge/robots/search_robots';
    public const XML_PATH_ROBOTS_FILTERED_CATEGORY = 'nativemind_flutterbridge/robots/filtered_category_robots';
    public const XML_PATH_ROBOTS_CART = 'nativemind_flutterbridge/robots/cart_robots';
    public const XML_PATH_ROBOTS_CHECKOUT = 'nativemind_flutterbridge/robots/checkout_robots';
    public const XML_PATH_ROBOTS_CUSTOMER = 'nativemind_flutterbridge/robots/customer_robots';

    // JSON-LD
    public const XML_PATH_JSONLD_ENABLED = 'nativemind_flutterbridge/jsonld/enabled';
    public const XML_PATH_JSONLD_MODE = 'nativemind_flutterbridge/jsonld/mode';
    public const XML_PATH_JSONLD_PRODUCT = 'nativemind_flutterbridge/jsonld/product_enabled';
    public const XML_PATH_JSONLD_BREADCRUMB = 'nativemind_flutterbridge/jsonld/breadcrumb_enabled';
    public const XML_PATH_JSONLD_ORGANIZATION = 'nativemind_flutterbridge/jsonld/organization_enabled';
    public const XML_PATH_JSONLD_CATEGORY_ITEMLIST = 'nativemind_flutterbridge/jsonld/category_itemlist_enabled';

    // OpenGraph
    public const XML_PATH_OPENGRAPH_ENABLED = 'nativemind_flutterbridge/opengraph/enabled';
    public const XML_PATH_OPENGRAPH_MODE = 'nativemind_flutterbridge/opengraph/mode';
    public const XML_PATH_OPENGRAPH_DEFAULT_IMAGE = 'nativemind_flutterbridge/opengraph/default_image';
    public const XML_PATH_OPENGRAPH_TWITTER_CARD = 'nativemind_flutterbridge/opengraph/twitter_card_type';

    // App Links
    public const XML_PATH_ANDROID_ENABLED = 'nativemind_flutterbridge/app_links/android_enabled';
    public const XML_PATH_ANDROID_PACKAGE = 'nativemind_flutterbridge/app_links/android_package_name';
    public const XML_PATH_ANDROID_FINGERPRINTS = 'nativemind_flutterbridge/app_links/android_sha256_fingerprints';
    public const XML_PATH_ANDROID_PLAYSTORE = 'nativemind_flutterbridge/app_links/android_playstore_url';
    public const XML_PATH_IOS_ENABLED = 'nativemind_flutterbridge/app_links/ios_enabled';
    public const XML_PATH_IOS_TEAM_ID = 'nativemind_flutterbridge/app_links/ios_team_id';
    public const XML_PATH_IOS_BUNDLE_ID = 'nativemind_flutterbridge/app_links/ios_bundle_id';
    public const XML_PATH_IOS_APPSTORE = 'nativemind_flutterbridge/app_links/ios_appstore_url';

    // App Banner
    public const XML_PATH_BANNER_ENABLED = 'nativemind_flutterbridge/app_banner/enabled';
    public const XML_PATH_BANNER_TITLE = 'nativemind_flutterbridge/app_banner/title';
    public const XML_PATH_BANNER_SUBTITLE = 'nativemind_flutterbridge/app_banner/subtitle';
    public const XML_PATH_BANNER_OPEN_TEXT = 'nativemind_flutterbridge/app_banner/open_button_text';
    public const XML_PATH_BANNER_INSTALL_TEXT = 'nativemind_flutterbridge/app_banner/install_button_text';
    public const XML_PATH_BANNER_SHOW_PRODUCT = 'nativemind_flutterbridge/app_banner/show_on_product';
    public const XML_PATH_BANNER_SHOW_CATEGORY = 'nativemind_flutterbridge/app_banner/show_on_category';
    public const XML_PATH_BANNER_SHOW_HOME = 'nativemind_flutterbridge/app_banner/show_on_home';
    public const XML_PATH_BANNER_DISMISS_DAYS = 'nativemind_flutterbridge/app_banner/dismiss_cookie_days';
