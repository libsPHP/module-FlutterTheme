<?php
/**
 * NativeMind FlutterBridgeRoutes Configuration Helper
 *
 * @category    NativeMind
...
{
    private const XML_PATH_ENABLED = 'nativemind_flutterbridge/route/enabled';
    private const XML_PATH_STANDARD_VERSION = 'nativemind_flutterbridge/route/standard_version';
    private const XML_PATH_PRODUCT_ROUTE = 'nativemind_flutterbridge/route/product_app_route';
    private const XML_PATH_CATEGORY_ROUTE = 'nativemind_flutterbridge/route/category_app_route';
    private const XML_PATH_CMS_ROUTE = 'nativemind_flutterbridge/route/cms_app_route';
    private const XML_PATH_SEARCH_ROUTE = 'nativemind_flutterbridge/route/search_app_route';
    private const XML_PATH_CART_ROUTE = 'nativemind_flutterbridge/route/cart_app_route';
    private const XML_PATH_CHECKOUT_ROUTE = 'nativemind_flutterbridge/route/checkout_app_route';
    private const XML_PATH_CUSTOMER_ROUTE = 'nativemind_flutterbridge/route/customer_app_route';
    private const XML_PATH_HOME_ROUTE = 'nativemind_flutterbridge/route/home_app_route';
