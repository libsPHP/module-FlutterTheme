...
namespace NativeMind\FlutterBridgeSeo\Helper;
...
class Config extends AbstractHelper
{
    ...
    public function isCanonicalEnabled(?int $storeId = null): bool
    {
        return $this->coreConfig->isEnabled($storeId) && $this->scopeConfig->isSetFlag(
            'nativemind_flutterbridge/canonical/enabled',
    ...
    public function getProductCanonicalMode(?int $storeId = null): string
    {
        return (string) $this->scopeConfig->getValue(
            'nativemind_flutterbridge/canonical/product_mode',
            ScopeInterface::SCOPE_STORE,
            $storeId
        ) ?: 'shortest';
    }
    ...
    public function shouldStripUtm(?int $storeId = null): bool
    {
        return $this->scopeConfig->isSetFlag(
            'nativemind_flutterbridge/canonical/strip_utm',
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }
    ...
    {
        return $this->scopeConfig->isSetFlag(
            'nativemind_flutterbridge/canonical/strip_tracking',
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }
    ...
    {
        return $this->coreConfig->isEnabled($storeId) && $this->scopeConfig->isSetFlag(
            'nativemind_flutterbridge/jsonld/enabled',
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }
    ...
    public function isProductJsonLdEnabled(?int $storeId = null): bool
    {
        return $this->isJsonLdEnabled($storeId) && $this->scopeConfig->isSetFlag(
            'nativemind_flutterbridge/jsonld/product_enabled',
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }
    ...
    {
        return (string) $this->scopeConfig->getValue(
            'nativemind_flutterbridge/robots/search_robots',
            ScopeInterface::SCOPE_STORE,
            $storeId
        ) ?: 'noindex,follow';
    }
    ...
    {
        return (string) $this->scopeConfig->getValue(
            'nativemind_flutterbridge/robots/cart_robots',
            ScopeInterface::SCOPE_STORE,
            $storeId
        ) ?: 'noindex,nofollow';
    }
