...
class Config extends AbstractHelper
{
    ...
    public function isEnabled(?int $storeId = null): bool
    {
        return $this->coreConfig->isEnabled($storeId) && $this->scopeConfig->isSetFlag(
            'nativemind_Bridge/flutterweb/enabled',
    ...
    public function getBaseUrl(?int $storeId = null): string
    {
        $url = (string) $this->scopeConfig->getValue(
            'nativemind_Bridge/flutterweb/base_url',
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    ...
    public function getLoaderTimeout(?int $storeId = null): int
    {
        return (int) $this->scopeConfig->getValue(
            'nativemind_Bridge/flutterweb/loader_timeout',
            ScopeInterface::SCOPE_STORE,
            $storeId
        ) ?: 5000;
    }
    ...
    public function isServiceWorkerEnabled(?int $storeId = null): bool
    {
        return $this->scopeConfig->isSetFlag(
            'nativemind_Bridge/flutterweb/service_worker_enabled',
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }
    ...
    public function getAllowedPageTypes(?int $storeId = null): array
    {
        $types = (string) $this->scopeConfig->getValue(
            'nativemind_Bridge/flutterweb/allowed_page_types',
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    ...
    public function getHideStrategy(?int $storeId = null): string
    {
        return (string) $this->scopeConfig->getValue(
            'nativemind_Bridge/flutterweb/hide_strategy',
            ScopeInterface::SCOPE_STORE,
            $storeId
    ...
    {
        return (string) $this->scopeConfig->getValue(
            'nativemind_Bridge/flutterweb/fallback_selector',
            ScopeInterface::SCOPE_STORE,
            $storeId
        ) ?: '.page-wrapper';
    }
    ...
    {
        return (string) $this->scopeConfig->getValue(
            'nativemind_Bridge/flutterweb/flutter_root_selector',
            ScopeInterface::SCOPE_STORE,
            $storeId
        ) ?: '#flutter-view';
    }
    ...
    {
        return (string) $this->scopeConfig->getValue(
            'nativemind_Bridge/flutterweb/bootstrap_script',
            ScopeInterface::SCOPE_STORE,
            $storeId
        ) ?: 'flutter.js';
    }
    ...
    {
        return (string) $this->scopeConfig->getValue(
            'nativemind_Bridge/flutterweb/asset_version',
            ScopeInterface::SCOPE_STORE,
            $storeId
        ) ?: '';
    }
    ...
    {
        return (string) $this->scopeConfig->getValue(
            'nativemind_Bridge/flutterweb/renderer',
            ScopeInterface::SCOPE_STORE,
            $storeId
        ) ?: 'auto';
    }
    ...
    {
        return (string) $this->scopeConfig->getValue(
            'nativemind_Bridge/flutterweb/load_mode',
            ScopeInterface::SCOPE_STORE,
            $storeId
        ) ?: self::LOAD_MODE_AUTO;
    }
    ...
    {
        return (string) $this->scopeConfig->getValue(
            'nativemind_Bridge/flutterweb/failure_mode',
            ScopeInterface::SCOPE_STORE,
            $storeId
