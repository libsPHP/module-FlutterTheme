...
class Config extends AbstractHelper
{
    ...
    public function isEnabled(?int $storeId = null): bool
    {
        return $this->coreConfig->isEnabled($storeId) && $this->scopeConfig->isSetFlag(
            'nativemind_flutterbridge/appbanner/enabled',
    ...
    public function getAppName(?int $storeId = null): string
    {
        return (string) $this->scopeConfig->getValue(
            'nativemind_flutterbridge/appbanner/app_name',
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }
    ...
    public function getAppIcon(?int $storeId = null): string
    {
        $icon = $this->scopeConfig->getValue(
            'nativemind_flutterbridge/appbanner/app_icon',
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    ...
    {
        return (string) $this->scopeConfig->getValue(
            'nativemind_flutterbridge/appbanner/android_store_url',
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }
    ...
    {
        return (string) $this->scopeConfig->getValue(
            'nativemind_flutterbridge/appbanner/ios_store_url',
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }
    ...
    {
        return (string) $this->scopeConfig->getValue(
            'nativemind_flutterbridge/appbanner/cta_text',
            ScopeInterface::SCOPE_STORE,
            $storeId
        ) ?: 'Open in App';
    }
    ...
    {
        return (string) $this->scopeConfig->getValue(
            'nativemind_flutterbridge/appbanner/position',
            ScopeInterface::SCOPE_STORE,
            $storeId
        ) ?: 'top';
    }
    ...
    public function getDismissDuration(?int $storeId = null): int
    {
        return (int) $this->scopeConfig->getValue(
            'nativemind_flutterbridge/appbanner/dismiss_duration',
            ScopeInterface::SCOPE_STORE,
            $storeId
        ) ?: 7;
    }
