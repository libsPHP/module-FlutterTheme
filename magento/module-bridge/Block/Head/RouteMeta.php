...
class RouteMeta extends Template
{
    ...
    /**
     * Check if route metadata output is enabled
     *
     * @return bool
     */
    ...
    /**
     * Detect current route type from request
     *
     * @return string
     */
    ...
    /**
     * Build simple route payload (cart, checkout, customer, home)
     *
     * @param string $type
